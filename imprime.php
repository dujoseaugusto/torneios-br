...
<table width="837" border="1">
  ...
  <tr>
    ...
    <td width="519" style="font-weight:bold;">Data do Etapa: <?php echo dtahoraela($linha['data_etapa']);?><br />
      Evento: <?php echo (retorna_nome($linha['id_temporada'],'arpag_temporada'));?><br />
      Etapa: <?php echo ($linha[2]);?><br />
      Prova: <?php echo (retorna_nome($linha['id_modalidade'],'arpag_modalidade'));?></td>
  ...
  <tr>
    ...
    <td colspan="2"><table width="100%" border="0">
      <tr>
        ...
        <td style="font-weight:bold;">Anilha: <?php echo ($linha['anilha']);?></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td style="font-weight:bold;">Proprietário</td>
    <td colspan="2"><?php echo ($linha[3]);?></td>
  </tr>
  <tr>
    <td style="font-weight:bold;">Clube</td>
    <td colspan="2"><?php echo (retorna_nome($linha['id_clube'],'arpag_clube'));?></td>
  </tr>
  <!--<tr>
