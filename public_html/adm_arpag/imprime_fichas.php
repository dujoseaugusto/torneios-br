  ...
  $cont = 1;
	while ($linha = $executa->fetch_array()){
       if(!$linha['id']) break;
        ...
        $consulta_pess->campo	= 'a.id, b.nome, c.nome, d.nome, c.data_etapa, c.local, b.anilha, b.id_modalidade, c.id_temporada,
                                   coalesce(d.id_clube,0) id_clube, a.numero';
        $consulta_pess->tabela	= "arpag_passaro_etapa AS a INNER JOIN arpag_passaro    AS b ON b.id = a.id_passaro
                                                        INNER JOIN arpag_etapa      AS c ON c.id = a.id_etapa
        ...
        <tr>
          <td width='100'><img src='../images/logotipo.jpg' width='100' height='95' /><br /><b>torneios.net.br</b></td>
          <td width='519' style='font-weight:bold;'>Data do Etapa: ". dtahoraela($linha_pess['data_etapa'])."<br />
            Evento: ". (retorna_nome($linha_pess['id_temporada'],'arpag_temporada'))."<br />
            Etapa: ". ($linha_pess[2])."<br />
            Prova: ". (retorna_nome($linha_pess['id_modalidade'],'arpag_modalidade'))."</td>
          <td width='196' style='font-weight:bold;'><p>Ave: ". $linha_pess[1]."<br />
          </p>
          <p>Estaca: ". $linha_pess['numero']."</p></td>
        </tr>
        <tr>
          ...
          <td colspan='2'><table width='100%' border='0'>
            <tr>
              <td>". ($linha_pess[1])." </td>
              <td style='font-weight:bold;'>Anilha: ". ($linha_pess['anilha'])."</td>
            </tr>
          </table></td>
        </tr>
        <tr>
          <td style='font-weight:bold;'>Proprietário</td>
          <td colspan='2'>". ($linha_pess[3])."</td>
        </tr>
        <tr>
          <td style='font-weight:bold;'>Clube</td>
          <td colspan='2'>".retorna_nome($linha_pess['id_clube'],'arpag_clube')."</td>
        </tr>
        <!--<tr>
          <td colspan='3' style='font-weight:bold; color:#F00; text-align:center;'>Declaro estar ciente e de acordo com o regulamento da Federação.</td>
        </tr>-->
        <tr>
        ...
        <tr>
          <td colspan='2' style='text-align:center !important; font-weight:bold;'>MARCAÇÃO FINAL</td>
          <td style='text-align:center !important; font-weight:bold;'>VISTO FISCAL</td>
        </tr>
        <tr>
          <td colspan='3'><table border='1' style='text-align:center !important;'>
        ...
        <tr>
          <td colspan='3'><table width='100%' height='145' border='1'>
            ...
            <tr>
              <td height='110' style='text-align:center !important; font-weight:bold;'>
              Declaro estar de inteira responsabilidade pelas informações prestadas, estando ciente
de que a falsidade nas informações acima implicará nas penalidades cabíveis</td>
  ...
  $mpdf=new mPDF('pt','A4',9.25,'',8,8,5,14,9,9,'P');
  $mpdf->WriteHTML($html);
  $mpdf->Output();
  exit();
?>
